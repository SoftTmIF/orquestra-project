package iftm.edu.br.orquestra.repository;

import iftm.edu.br.orquestra.model.PesquisaTask;
import iftm.edu.br.orquestra.model.Task;
...
public class TaskRepository {
        ...
        return jdbcTemplate.query(
                ...
                (resultado, numeroDaLinha) -> {
                    return new Task(
                            ...
                            mapa.get(resultado.getString("tipo_natureza")).toString(), // buscar no mapa a descrição da
                                                                                       // natureza
    ...
    public int insereUsuarioProjeto(Task task) {
        try {
            String consulta = "INSERT INTO usuario_projeto (usuario_r, projeto_r) VALUES(?,?)";
            return jdbcTemplate.update(consulta,
                    UsuarioRepository.buscaPorUsuario(task.getUsuario()).getId_usuario(),
                    task.getIdProjeto());
